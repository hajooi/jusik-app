                          ...
                          <Link
                            ...
                            className={`group flex items-center gap-2.5 p-2.5 rounded-xl text-xs transition-all duration-200 cursor-pointer ${
                              isActive
                                ...
                                : completed
                                ? 'border border-[var(--accent-green)] bg-[var(--accent-green)]/10 text-[var(--accent-green)] font-bold hover:border-[var(--accent-orange)] hover:bg-[var(--accent-orange)]/15 hover:text-[var(--accent-orange)]'
