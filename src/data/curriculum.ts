...
export interface BookSection {
  ...
  paragraphs: string[];
  callout?: string;
  interactiveTool?: 'labor_simulator';
}
        ...
        bookSections: [
          {
            ...
            paragraphs: [
              "\"만약 당신의 월급이 내일부터 완전히 사라진다면, 당신은 무엇을 준비하셨습니까?\"",
          ...
          },
          {
            ...
            paragraphs: [
              ...
              "스마트폰을 켜고 터치 몇 번으로 애플, 마이크로소프트, 엔비디아 같은 세계적인 우량 기업의 주식을 단 한 주라도 구매해 내 계좌에 담는 순간, 우리는 더 이상 그들의 값비싼 서비스를 소비하기만 하는 수동적인 소비자에 머물지 않습니다. 거인들이 전 세계에서 밤낮없이 벌어들이는 거대한 이익의 과실을 함께 요구하고 나눌 수 있는 당당한 주주이자 자본가의 위치로 올라서게 됩니다. 내 돈이 나를 대신해 24시간 일하는 구조를 구축하는 것, 이것이 자본주의 생태계에서 우리가 경제적으로 독립할 수 있는 유일한 해결책입니다.",
