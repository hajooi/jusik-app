...
export interface BookSection {
  ...
  paragraphs: string[];
  callout?: string;
  interactiveTool?: 'labor_simulator' | 'wealth_chart' | 'class_detector';
}
      ...
      },
      {
        ...
        bookSections: [
          ...
          },
          {
            ...
            paragraphs: [
              "사람들은 흔히 주식 투자가 차갑고 이성적인 분석의 영역이라고 굳게 믿고 싶어 합니다. 기업의 재무제표를 빈틈없이 뜯어보고, 산업 동향을 공부하며, 정교한 미래 가치를 계산해 내는 것이 투자의 전부라고 생각하는 것입니다. 그러나 세계적인 자산가이자 현인으로 칭송받는 찰리 멍거는 이에 대해 아주 묵직한 통찰을 남겼습니다. 대부분의 투자자가 시장에서 쓰라린 실패를 맛보는 이유는 그들의 '지능'이 부족해서가 아니라, 본능적인 '성격'을 다스리지 못하기 때문이라는 일침이었습니다.",
          ...
          },
          {
            ...
            paragraphs: [
              ...
              "만약 차분히 들여다본 내 마음이 시장이 쳐둔 그물에 걸려든 유혹에 불과하다면, 백지나 스마트폰 화면에 이렇게 한 줄을 적어보는 것입니다.",
          ...
          },
          {
            ...
            paragraphs: [
              ...
              "시장을 이기려는 오만한 욕심을 내려놓으십시오. 그 거대한 시장보다 훨씬 더 복잡하고 길들여지지 않은 '나 자신'을 객관적으로 해석하고 통제하는 능력이 비로소 갖춰질 때, 여러분의 소유권 계좌는 본능의 공포와 조급함에서 벗어나 흔들리지 않는 단단한 확신과 부로 안전하게 채워지기 시작할 것입니다. 기술이 아닌 철학이 마침내 여러분에게 진짜 밥을 먹여다 줍니다."
            ]
          }
        ]
      }
