...
export interface BookSection {
  ...
  paragraphs: string[];
  callout?: string;
  interactiveTool?: 'labor_simulator' | 'wealth_chart' | 'class_detector' | 'cisco_mania' | 'basic_terms_quiz' | 'fee_comparison';
}
            ...
            steps: [
              {
                ...
                bullets: [
                  ...
                  "해외 전용 퀵메뉴 Off: 메뉴 → 설정 → '해외주식 전용 퀵메뉴 사용' 토글 끄기"
                ]
              },
              {
                stepNumber: 2,
                ...
                bullets: [
                  ...
                  "미국 실시간 시세 무료 신청: 서비스신청 → 해외주식실시간시세신청 → 미국(0.0 USD) 신청 완료"
                ]
              },
              {
                stepNumber: 3,
                ...
                icon: "Target",
                bullets: [
                  "보유자산 확인: 종합매매 계좌에 투자금(100만 원) 입금 확인",
                  "종목 검색: 해외주식주문 왼쪽 위 종목명 클릭 → 미국의 500대 우량기업 ETF인 'SPYM' 검색 및 선택"
                ]
              },
              {
                stepNumber: 4,
                title: "4단계: 주식 구매 실습 (지정가 & 정정/취소)",
                icon: "ShoppingBag",
                bullets: [
                  "호가창 및 지정가: 호가창(파란 매도호가/빨간 매수호가) 확인 후 지정가 선택",
                  "수량입력기: 수량 필드 클릭 → 수량입력기에서 1주 입력 후 확인",
                  "구매 주문: 빨간색 [매수] 버튼 터치 시 통합증거금으로 달러 환전 없이 즉시 체결",
                  "정정/취소 원리: 미체결 대기 주문 발생 시 주문체결 탭에서 가격 정정으로 즉시 체결 가능",
                  "소수점 매매(소액 투자): 메뉴 → 해외주식 → 소수점주문에서 10,000원 등 원하는 금액 단위로 소액 구매 가능"
                ]
              },
              {
                stepNumber: 5,
                title: "5단계: 보유자산 확인 & 통합증거금 원리",
                icon: "PieChart",
                bullets: [
                  "보유자산 확인: 구매한 SPYM 주식 및 실시간 평가손익 조회",
                  "통합증거금 5% 가계산: 환율 변동 대비로 5% 정도 임시 묶어둔 뒤, 결제일(D+2)에 남은 금액은 자동 환급"
                ]
              },
              {
                stepNumber: 6,
                title: "6단계: 주식 팔기 & 출금 안내 (D+2 결제일)",
                icon: "RefreshCw",
                bullets: [
                  "주식 팔기: 해외주식주문 [팔기(매도)] 탭에서 원하는 수량과 가격으로 매도 주문",
