...
export const CURRICULUM_DATA: Level[] = [
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        duration: "5:39",
        summary: [
          "오늘의 500만 원과 20년 뒤의 500만 원은 완전히 다른 가치입니다.",
          "'현재가치' 개념에 따르면, 미래의 돈보다 지금 즉시 쥐는 목돈이 압도적으로 가치 있습니다.",
          "돈이 가진 시간의 힘을 이용해 돈이 스스로 일하게 만드는 능동적인 '투자자'이자 자본가가 되어야 합니다."
        ],
        cardNewsTitles: [
        ...
        bookSections: [
          ...
          },
          {
            ...
            paragraphs: [
              ...
              "자본주의 사회의 화폐 가치는 인플레이션이라는 보이지 않는 흐름에 밀려 시간이 흐를수록 예외 없이 약해집니다. 물가가 상승한다는 것은 뒤집어 말하면 화폐의 구매력이 가파르게 무너지고 있음을 뜻합니다. 경제학에서는 이를 '현재가치(Present Value)'라는 개념으로 설명합니다. 미래에 받게 될 돈은 불확실성과 지속적인 물가 상승률 등을 종합적으로 고려하여, 현재 시점의 가치로 환산할 때 그 금액을 일정 부분 대폭 낮추어 평가해야 한다는 냉정한 규칙입니다.",
          ...
          },
          {
            ...
            paragraphs: [
              ...
              "말로만 들으면 쉽게 와닿지 않을 수 있습니다. 이를 철저한 역사적 데이터와 숫자로 증명해 보겠습니다. 전 세계 주식 시장을 이끄는 미국 500개 기업(S&P 500)의 역사적 연평균 수익률인 8%를 대입하여, 30년 동안 두 사람이 각기 다른 방식으로 투자했을 때 벌어지는 자산의 격차를 추적해 보았습니다.",
              "두 사람 모두 30년이라는 똑같은 시간을 보냈고, 심지어 투입된 자본의 절대적 누적 흐름은 유사함에도 불구하고 오직 '출발점의 규모'가 달랐다는 이유 하나만으로 최종 자산에서 무려 30억 원의 거대한 격차가 발생합니다.",
